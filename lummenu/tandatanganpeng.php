...
<body>
	 ...
	 <?php echo "<a href=../siswa/ttdb/index.php?id=".$hasilx['id']." class='btn btn-primary btn-sm' role='button' "?> onclick="NewWindow(this.href,'name','400','400','yes');return false" <?php echo "> <span class='glyphicon glyphicon-plus'><strong>Tanda Tangan</strong> </a> &nbsp &nbsp";
