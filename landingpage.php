...
<div class="about-img-wrap">
  ...
  <div class="about-modern-img">
    ...
    <div class="about-floating-card">
      <span class="about-year">2015</span>
...
<div class="skema-grid">
  <div class="skema-card">
    ...
    <p>Instalasi, konfigurasi, administrasi, dan pemeliharaan jaringan komputer serta perangkat pendukungnya.</p>
    <span class="skema-code">TKJ</span>
  </div>

  <div class="skema-card">
    <div class="skema-icon"><svg viewBox="0 0 24 24"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg></div>
    <h3>Desain Komunikasi Visual</h3>
    <p>Perancangan identitas visual, desain grafis, ilustrasi, layout, dan konten kreatif digital.</p>
    <span class="skema-code">DKV</span>
  </div>

  <div class="skema-card">
    <div class="skema-icon"><svg viewBox="0 0 24 24"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg></div>
    <h3>Rekayasa Perangkat Lunak</h3>
    <p>Pengembangan aplikasi, pemrograman, basis data, pengujian, dan pemeliharaan perangkat lunak.</p>
    <span class="skema-code">RPL</span>
  </div>

  <div class="skema-card">
    <div class="skema-icon"><svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="14" rx="2"/><path d="M7 20h10"/><path d="M9 12h6"/><path d="M12 9v6"/></svg></div>
    <h3>Sistem Informasi Jaringan dan Aplikasi</h3>
    <p>Integrasi sistem informasi, jaringan, aplikasi, dan layanan digital berbasis kebutuhan industri.</p>
    <span class="skema-code">SIJA</span>
  </div>

  <div class="skema-card">
    <div class="skema-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a8 8 0 0 0 .1-6"/><path d="M4.5 9a8 8 0 0 0 .1 6"/><path d="M8 4.8a8 8 0 0 1 8 0"/><path d="M16 19.2a8 8 0 0 1-8 0"/></svg></div>
    <h3>Teknik Pemesinan</h3>
    <p>Pengoperasian mesin perkakas, pengukuran, pembubutan, pengefraisan, dan proses produksi komponen.</p>
    <span class="skema-code">TP</span>
  </div>

  <div class="skema-card">
    <div class="skema-icon"><svg viewBox="0 0 24 24"><path d="M3 21h18"/><path d="M6 21V7l6-4 6 4v14"/><path d="M9 21v-6h6v6"/></svg></div>
    <h3>Teknik Fabrikasi Logam dan Manufaktur</h3>
    <p>Pengerjaan fabrikasi, pengelasan, perakitan, dan proses manufaktur berbasis standar kerja industri.</p>
    <span class="skema-code">TFLM</span>
  </div>

  <div class="skema-card">
    <div class="skema-icon"><svg viewBox="0 0 24 24"><path d="M3 13l2-5h14l2 5"/><path d="M5 13h14v6H5z"/><circle cx="8" cy="19" r="2"/><circle cx="16" cy="19" r="2"/></svg></div>
    <h3>Teknik Kendaraan Ringan</h3>
    <p>Perawatan, pemeriksaan, diagnosis, dan perbaikan kendaraan ringan sesuai prosedur teknis.</p>
    <span class="skema-code">TKR</span>
  </div>

  <div class="skema-card">
    <div class="skema-icon"><svg viewBox="0 0 24 24"><path d="M3 21h18"/><path d="M4 10l8-6 8 6"/><path d="M6 21V10h12v11"/><path d="M10 21v-6h4v6"/></svg></div>
    <h3>Teknik Konstruksi dan Perumahan</h3>
    <p>Pelaksanaan pekerjaan konstruksi, perencanaan teknis, dan pembangunan perumahan.</p>
    <span class="skema-code">TKP</span>
  </div>

  <div class="skema-card">
    <div class="skema-icon"><svg viewBox="0 0 24 24"><path d="M4 20V4h16v16Z"/><path d="M8 20V8h8v12"/><path d="M8 12h8"/><path d="M12 8v12"/></svg></div>
    <h3>Desain Pemodelan dan Informasi Bangunan</h3>
    <p>Perancangan gambar bangunan, pemodelan digital, dan pengelolaan informasi konstruksi.</p>
    <span class="skema-code">DPIB</span>
  </div>

  <div class="skema-card">
    <div class="skema-icon"><svg viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="2"/><path d="M9 9h6v6H9z"/><path d="M9 1v3"/><path d="M15 1v3"/><path d="M9 20v3"/><path d="M15 20v3"/><path d="M20 9h3"/><path d="M20 15h3"/><path d="M1 9h3"/><path d="M1 15h3"/></svg></div>
    <h3>Teknik Otomasi Industri</h3>
    <p>Pengoperasian sistem otomasi, kontrol industri, sensor, aktuator, dan perangkat kendali produksi.</p>
    <span class="skema-code">TOI</span>
  </div>
</div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
  const links = {
    ...
    'Tentang Kami': document.querySelectorAll('.section')[0],
    'Skema Sertifikasi': document.querySelectorAll('.section')[1],
    'Prosedur': document.querySelectorAll('.section')[2],
    'Jadwal': document.querySelectorAll('.section')[3],
    'Kontak': document.querySelectorAll('.section')[4]
  };

  document.querySelectorAll('.nav-links a, .footer-col a').forEach(a => {
    const target = links[a.textContent.trim()];
    if (!target) return;
  ...
  document.querySelector('.nav-btn')?.setAttribute('href', 'lsp_login.php');
  document.querySelector('.hero-actions .btn-primary')?.setAttribute('href', 'lsp_login.php');

  const panduan = document.querySelector('.hero-actions .btn-outline');
  if (panduan) {
    panduan.onclick = e => {
      e.preventDefault();
      window.scrollTo({
        top: links['Prosedur'].offsetTop - 110,
        behavior: 'smooth'
      });
    };
  }
