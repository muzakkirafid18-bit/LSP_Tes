...
/**
 * ============================================================
 *  TEMPLATE HEADER — LSP SMKN 1 Cibinong (VERSI ASESI/PESERTA)
 * ============================================================
 *
 *  CARA PAKAI di setiap halaman PHP asesi:
 *
 ...
 *     $page_title   = "Pilih Skema";          // Judul di topbar
 *     $page_sub     = "Pilih skema sertifikasi"; // Sub-judul kecil
 *     $active_menu  = "pilihskema";            // Nama menu aktif
 *
 *     include "../lummenu/template_header_asesi.php";
 *     ?>
 *
 *  2. Tulis konten halaman kamu di sini
 *
 *  3. Di paling bawah:
 *     <?php include "../lummenu/template_footer.php"; ?>
 *
 * ============================================================
 */
...
.sidebar-nav { padding: 16px 12px; flex: 1 0 auto; }
.nav-label {
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="pilihskema.php"  class="nav-item <?= isActive('pilihskema', $active_menu) ?>">
            <i class="fas fa-sitemap"></i> Pilih SKema
        </a>
        <a href="pilihunit.php"   class="nav-item <?= isActive('pilihunit', $active_menu) ?>">
            <i class="fas fa-cubes"></i> Pilih Unit
        </a>

        <div class="nav-label">Formulir APL</div>
        <a href="dashsiswa.php"   class="nav-item <?= isActive('apl1', $active_menu) ?>">
            <i class="fas fa-file-alt"></i> FR.APL. 1
        </a>
        <a href="apl2.php"        class="nav-item <?= isActive('apl2', $active_menu) ?>">
            <i class="fas fa-chart-line"></i> FR. APL. 2
        </a>

        <div class="nav-label">Asesmen</div>
        <a href="portofolio.php"  class="nav-item <?= isActive('portofolio', $active_menu) ?>">
            <i class="fas fa-folder-open"></i> Portofolio
        </a>
        <a href="testulis.php"    class="nav-item <?= isActive('testulis', $active_menu) ?>">
            <i class="fas fa-pencil-alt"></i> FR.IA.05 Pertanyaan Tertulis
        </a>
        <a href="mak5.php"         class="nav-item <?= isActive('mak3', $active_menu) ?>">
            <i class="fas fa-file-signature"></i> FR.AK.03
        </a>

        <div class="nav-label">Informasi</div>
        <a href="statussaya.php"  class="nav-item <?= isActive('statussaya', $active_menu) ?>">
            <i class="fas fa-map"></i> Cek Status
        </a>
        <a href="banding.php"     class="nav-item <?= isActive('banding', $active_menu) ?>">
            <i class="fas fa-map"></i> FR.AK.04 Banding
        </a>
        <a href="rahasia.php"     class="nav-item <?= isActive('kerahasiaan', $active_menu) ?>">
            <i class="fas fa-map"></i> FR.AK.01 Kerahasiaan
        </a>

        <div class="nav-label">Akun</div>
        <a href="ubahpassword.php" class="nav-item <?= isActive('ubahpassword', $active_menu) ?>">
